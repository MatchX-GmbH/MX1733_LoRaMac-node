 ...
 */
void SX1276OnTimeoutIrq( OS_TIMER timer );
 ...
 * Tx and Rx timers
 */
static OS_TIMER TxTimeoutTimer;
static OS_TIMER RxTimeoutTimer;
static OS_TIMER RxTimeoutSyncWord;
...
uint32_t SX1276GetTimeOnAir( RadioModems_t modem, uint8_t pktLen )
{
    ...
    case MODEM_FSK:
        {
            airTime = (double)( ( 8 * ( SX1276.Settings.Fsk.PreambleLen +
    ...
    case MODEM_LORA:
        {
            ...
            double tmp = (double)( ( 8 * pktLen - 4 * SX1276.Settings.LoRa.Datarate +
            ...
            // return us secs
            airTime = (double)( tOnAir * 1e3 + 0.999 );
        }
        break;
    }
    return airTime;
...
void SX1276SetTx( uint32_t timeout )
{
    ...
    OS_TIMER_START(TxTimeoutTimer, OS_TIMER_FOREVER);
...
{
    OS_ASSERT( ( SX1276.Spi.spi_conf != NULL ) );
